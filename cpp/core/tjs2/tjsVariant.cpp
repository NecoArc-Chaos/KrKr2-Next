...
namespace TJS {
    ...
    tTJSVariantOctet::tTJSVariantOctet(const tTJSVariantOctet *o1,
        ...
        if(o2 && o2->Length)
            TJS_octetcpy(Data + (o1 ? o1->Length : 0), o2->Data, o2->Length);
    }

    //---------------------------------------------------------------------------
    tTJSVariantOctet::~tTJSVariantOctet() { delete[] Data; }
    ...
    //---------------------------------------------------------------------------
    void TJSDeallocVariantOctet(tTJSVariantOctet *o) { delete o; }
