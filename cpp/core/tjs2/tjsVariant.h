...
#pragma pack(pop)
    ...
    public:
        ...
        TJS_METHOD_DEF(void, AddRef, ()) { RefCount++; }

        TJS_METHOD_DEF(void, Release, ());

        TJS_CONST_METHOD_DEF(tjs_uint, GetLength, ()) { return Length; }

        TJS_CONST_METHOD_DEF(const tjs_uint8 *, GetData, ()) { return Data; }
...
/*]*/
    ...
    public:
        ...
        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant,
                       (const tTJSVariant &ref)); // from tTJSVariant
        ...
        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant,
                       (iTJSDispatch2 * obj,
                        iTJSDispatch2 *objthis)) // from closure
        {
            if(obj)
                obj->AddRef();
            if(objthis)
        ...
        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant,
                       (const tjs_char *ref)) //  from String
        {
            vt = tvtString;
            if(ref) {
        ...
        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant,
                       (const tTJSString &ref)) // from tTJSString
        {
            vt = tvtString;
        ...
        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant,
                       (const tjs_nchar *ref)) //  from NarrowString
        {
            vt = tvtString;
            if(ref) {
                String = TJSAllocVariantString(ref);
        ...
        TJS_METHOD_DEF(tTJSVariant &, operator=,
                       (tTJSVariantString * ref)); // from tTJSVariantString
        TJS_METHOD_DEF(tTJSVariant &, operator=,
                       (tTJSVariantOctet * ref)); // from tTJSVariantOctet
        TJS_METHOD_DEF(tTJSVariant &, operator=,
                       (const tTJSString &ref)); // from tTJSString
        TJS_METHOD_DEF(tTJSVariant &, operator=,
                       (const tjs_char *ref)); //  from String
        TJS_METHOD_DEF(tTJSVariant &, operator=,
                       (const tjs_nchar *ref)); // from narrow string
