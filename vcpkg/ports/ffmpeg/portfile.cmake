...
if (VCPKG_TARGET_ARCHITECTURE STREQUAL "x86" OR VCPKG_TARGET_ARCHITECTURE STREQUAL "x64")
    if(VCPKG_HOST_IS_WINDOWS)
        ...
        set(X86_ASSEMBLER "${YASM}")
    else()
        vcpkg_find_acquire_program(NASM)
        set(X86_ASSEMBLER "${NASM}")
    endif()
    get_filename_component(X86_ASSEMBLER_EXE_PATH "${X86_ASSEMBLER}" DIRECTORY)
endif()
...
if(X86_ASSEMBLER)
    list(APPEND prog_env "${X86_ASSEMBLER_EXE_PATH}")
    if(VCPKG_HOST_IS_WINDOWS)
        set(X86_ASSEMBLER_CONFIGURE_OPTION " --yasmexe=yasm")
    endif()
endif()
string(APPEND OPTIONS "${X86_ASSEMBLER_CONFIGURE_OPTION}")
