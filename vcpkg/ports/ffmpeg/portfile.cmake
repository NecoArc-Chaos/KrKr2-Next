...
if(VCPKG_HOST_IS_WINDOWS AND NASM)
    file(TO_CMAKE_PATH "${NASM}" NASM_CMAKE_PATH)
    if(NASM_CMAKE_PATH MATCHES "^([A-Za-z]):/(.*)$")
        string(TOLOWER "${CMAKE_MATCH_1}" NASM_DRIVE)
        set(NASM_MSYS_PATH "/${NASM_DRIVE}/${CMAKE_MATCH_2}")
    else()
        set(NASM_MSYS_PATH "${NASM_CMAKE_PATH}")
    endif()
    set(NASM_CONFIGURE_OPTION " --yasmexe=\"${NASM_MSYS_PATH}\"")
endif()
string(APPEND OPTIONS "${NASM_CONFIGURE_OPTION}")
